(function() {
  ...
  angular
    .module('nonoApp')
    .controller('DebtPickController', DebtPickController);

  /** @ngInject */
  function DebtPickController($rootScope, $stateParams, InvtApi, $scope, utils, $state, localStorageService, toastr) {
    var vm = this;　
    vm.isChoose = false;
    vm.add = add;
    ...
    function goBack() {
      ...
      $state.go('records:transferDetail', { id: '', type: 1 });
    }
